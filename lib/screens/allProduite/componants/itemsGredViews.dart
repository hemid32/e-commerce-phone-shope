    ...
    return Container(
      child: BlocConsumer<BlocFatchData ,  StateFatchData>(
        ...
        builder: (context, snapshot) {
          ...
          if(BlocFatchData.get(context).showAllFromScreenAllProducts.isEmpty  ) return Align(alignment: Alignment.center, child: CircularProgressIndicator(color: kPrimaryColor,)) ; else
          return Column(
            children: [
